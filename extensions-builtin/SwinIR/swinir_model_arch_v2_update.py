...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        if self.use_memory_efficient:
            ...
            qkv_xformers = torch.cat((qkv, pad), 4)
            ...
            q = torch.tensor(q * logit_scale, dtype=torch.float16)

            out = xops.memory_efficient_attention(q, k, v, attn_bias=attn_bias, p = self.attn_drop_val)
            out = out[:, :, :, :-2]
